    ...
    if (ci && name && lastName && edad && mun && sex && numCont) {
      ...
      if (response.status === 201) {
        response = await axios.post(
          "http://localhost:3000/api/user/client",
          user
        );
        if (response.status === 201) {
        ...
        <Col span={30}>
          <Flex vertical={true}>
            <Form.Item
              ...
              name="nombre"
              rules={[
                { required: true, message: t("messageError.emptyName") },
            ...
            <Form.Item
              ...
              name="ci"
              rules={[
                { required: true, message: "Introduce tu CI!" },
            ...
            <Form.Item
              ...
              name="segundo_nombre"
              rules={[
                { required: false, message: t("messageError.emptySecondName") },
                { min: 4, message: t("messageError.minCharMiddleName") },
                { max: 20, message: t("messageError.maxCharMiddleName") },
              ]}
            >
              <Input
                onChange={(e) => setSecondtName(e.target.value)}
                style={{ marginBottom: margin, width: 300 }}
            ...
            <Form.Item
              ...
              name="apellido"
              rules={[
                { required: true, message: t("messageError.emptyLastName") },
          ...
          <Flex vertical={true}>
            <Form.Item
              ...
              rules={[
                {
                  required: false,
                  message: t("messageError.emptySecondLastName"),
                },
            ...
            <Form.Item
              ...
              name="user_name"
              rules={[
                { required: true, message: "Introduce tu matricula!" },
                {
                  min: 4,
                  message:
                    "Su nombre de usuario debe tener al menos 4 caracteres",
                },
                {
                  max: 20,
                  message:
                    "Su nombre de usuario debe tener a lo mas 20 caracteres",
                },
              ]}
            >
              <Input
            ...
            <Form.Item
              ...
              name="email"
              rules={[
                { required: true, message: t("messageError.emptyEmail") },
                {
                  validator: (rule, value, callback) => {
                    if (rule && value) {
                      ...
                      if (emailValue.includes("@gmail.com")) {
                        ...
                        callback(
                          new Error(t("messageError.extensionGMAIL.COM"))
                        );
                      }
                    }
                  },
            ...
            <Form.Item
              ...
              rules={[
                ...
                {
                  max: 8,
                  message: "La contraseña debe tener a lo mas 8 caracteres",
                },
          ...
          <Flex vertical={true}>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: t("messageError.emptyContactNumber"),
                },
            ...
            <Form.Item
              label={t("profile.age") + ":"}
              name="edad"
              rules={[{ required: true, message: t("messageError.emptyAge") }]}
            >
              <InputNumber
                min={18}
                max={70}
                onChange={(value) => setEdad(value)}
                style={{ marginBottom: margin, width: 60 }}
                placeholder="Edad"
              />
            </Form.Item>
            ...
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: t("messageError.emptyMunicipality"),
                },
              ]}
            >
              <Select
                onSelect={(value) => setMun(value)}
                style={{ marginBottom: margin, width: 200 }}
                placeholder={t("profile.municipality")}
              >
                {dataSource.map((item, i) => (
                  <Select.Option key={i} value={item.nommun}>
                    {item.nommun}
                  </Select.Option>
                ))}
              </Select>
            ...
            <Form.Item
              label={t("profile.sex") + ":"}
              name="sexo"
              rules={[{ required: true, message: t("messageError.emptySex") }]}
            >
              <Select
